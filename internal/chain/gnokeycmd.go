...
// command won't sign as-is; it is for understanding and display. The gas flags
// are gnomcp's pinned defaults (the chain-minimum fee — see DefaultGasFeeUgnot).
//
...
func (g GnokeyCmd) String() string {
	...
	parts = append(parts,
		"-gas-fee", fmt.Sprintf("%dugnot", DefaultGasFeeUgnot),
